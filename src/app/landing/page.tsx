...
const HomePage = () => {
  return (
    <div className="flex portrait:flex-col portrait:pt-32 sm:py-6 sm:flex-row sm:justify-between min-h-[100vh] items-center sm:px-10 text-white bg-gradient-to-r from-[#22333b] via-[#a3b18a] to-[#001219] bg-[length:200%_200%] animate-gradient-bg overflow-hidden">
      ...
      <div className="flex-shrink-0 portrait:pb-28">
        <Image
          ...
          height="500"
          priority
          className="sm:bounce-animation sm:hover:scale-110 transition-all duration-300 ease-in-out max-w-full w-full portrait:ml-2"
        />
      </div>
    </div>
  );
